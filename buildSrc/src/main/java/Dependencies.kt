object Deps {
    ...
    const val DAGGER_HILT_VIEWMODEL =
        "androidx.hilt:hilt-lifecycle-viewmodel:${Version.DAGGER_HILT_ANDRIODX_LIFECYCLE}"
    const val DAGGER_HILT_ANDROIDX_HILT_COMPILER =
        "androidx.hilt:hilt-android-compiler:${Version.DAGGER_HILT_ANDRIODX}"
    ...
    //ViewPager Indicator
    const val VIEWPAGER_INDICATOR =
        "com.github.zhpanvip:viewpagerindicator:${Version.VIEWPAGER_INDICATOR_VERSION}"
    ...
    //Datastore
    const val DATASTORE = "androidx.datastore:datastore-preferences:${Version.DATASTORE_VERSION}"
}
